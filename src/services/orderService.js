...
const createOrder = async (payload) => {
  ...
  sendMail(
      ...
      `Order Confirmation for ${createdOrder.course.title}`,
      `Thank you for choosing CraftIQ ! We're excited to confirm your recent order for the ${createdOrder.course.title}\n
